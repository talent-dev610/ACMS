...
class LatLngBounds {
  ...
  double get west => southWest?.longitude ?? 0;
  double get south => southWest?.latitude ?? 0;
  double get east => northEast?.longitude ?? 0;
  double get north => northEast?.latitude ?? 0;
  ...
  bool containsBounds(LatLngBounds bounds) {
    ...
    if (sw2 == null || ne2 == null || sw == null || ne == null) {
      return false;
    }
